...
// Number validation
exports.numberGreaterThan = function (otherNum) { return function (num) { return num > otherNum; }; };
exports.numberGreaterThanOrEqual = function (otherNum) { return function (num) { return num >= otherNum; }; };
exports.numberLessThan = function (otherNum) { return function (num) { return num < otherNum; }; };
exports.numberLessThanOrEqual = function (otherNum) { return function (num) { return num <= otherNum; }; };
