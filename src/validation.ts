...
export function validateField<T>(
  ...tuples: Array<[(str: T) => boolean, string]>
) {
  return (value: T) =>
    tuples.reduce<string | undefined>((result, [func, errMessage]) => {
...
// String validation
export const stringGreaterThan = (length: number) => (str: string) =>
  str.length > length
export const stringGreaterThanOrEqual = (length: number) => (str: string) =>
  str.length >= length
export const stringLessThan = (length: number) => (str: string) =>
  str.length < length
export const stringLessThanOrEqual = (length: number) => (str: string) =>
  str.length <= length

// Number validation
export const numberGreaterThan = (otherNum: number) => (num: number) =>
  num > otherNum
export const numberGreaterThanOrEqual = (otherNum: number) => (num: number) =>
  num >= otherNum
export const numberLessThan = (otherNum: number) => (num: number) =>
  num < otherNum
export const numberLessThanOrEqual = (otherNum: number) => (num: number) =>
  num <= otherNum
